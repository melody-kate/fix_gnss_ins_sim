...
def get_gnss_ins_sim(motion_def_file,fs_imu,fs_gps):
    ...
    rospy.logwarn(
        'Simulated data size: Gyro-{}, Accel-{}, pos-{}'.format(len(sim.dmgr.get_data_all('gyro').data[0]),
